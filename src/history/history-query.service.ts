...
const AUDIT_ACTION_METADATA_KEYS: Record<string, readonly string[]> = {
  ...
  'user.created_from_invite': ['inviteId', 'assignedRole'],
  'user.created_manual': ['assignedRole'],
  'user.updated': [
    'fields',
    'beforeRole',
    'afterRole',
  ...
  'user.session_revoked': ['reason', 'sessionId', 'revokedCount'],
  'user.sessions_revoked_all': ['reason', 'revokedCount'],
  'user.mfa_reset': ['reason', 'sessionsRevoked', 'recoveryCodesRevoked'],
  'user.password_reset_requested': ['reason', 'supersededRequests', 'deliveryStatus'],
